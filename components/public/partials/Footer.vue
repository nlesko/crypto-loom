        ...
        <div class="w-full border-y border-[#DDDDDD]">
            <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
                ...
                <div
                    ...
                    <ul class="space-y-4">
                        <PublicNavLink name="Products" url="#" />
                        <PublicNavLink name="About Us" url="#" />
                        <PublicNavLink name="Careers" url="#" />
                        <PublicNavLink name="Blog" url="#" />
                        <PublicNavLink name="Security" url="#" />
                    </ul>
                </div>
                <div
                    ...
                    <ul class="space-y-4">
                        <PublicNavLink name="Help Center" url="#" />
                        <PublicNavLink name="Contact Us" url="#" />
                        <PublicNavLink name="System Status" url="#" />
                        <PublicNavLink name="Area of Avaibility" url="#" />
                        <PublicNavLink name="Privacy Policy" url="#" />
                    </ul>
                </div>
                <div
                    ...
                    <h5 class="text-sm font-medium text-[#666666] focus:outline-none focus:shadow-outline">Newsletter
                    </h5>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button
                            ...
                            <MdiIcon icon="mdiArrowRight" :size="20" />
                        </button>
                    </div>
                </div>
            </div>
